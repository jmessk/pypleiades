...
class RequestJobUpdate(object):
    ...
    def __init__(self, output=None, status=None):  # noqa: E501
        """RequestJobUpdate - a model defined in Swagger"""  # noqa: E501
        self._output = None
        self._status = None
    ...
    @property
    def output(self):
        """Gets the output of this RequestJobUpdate.  # noqa: E501


        :return: The output of this RequestJobUpdate.  # noqa: E501
        :rtype: str
        """
        return self._output
    ...
    def output(self, output):
        """Sets the output of this RequestJobUpdate.


        :param output: The output of this RequestJobUpdate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this RequestJobUpdate.  # noqa: E501


        :return: The status of this RequestJobUpdate.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this RequestJobUpdate.


        :param status: The status of this RequestJobUpdate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RequestJobUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestJobUpdate):
            return False
