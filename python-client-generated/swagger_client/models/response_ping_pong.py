...
class ResponsePingPong(object):
    ...
    def __init__(self, code=None, status=None, message=None):  # noqa: E501
        """ResponsePingPong - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._status = None
        self._message = None
    ...
    @property
    def code(self):
        """Gets the code of this ResponsePingPong.  # noqa: E501


        :return: The code of this ResponsePingPong.  # noqa: E501
        :rtype: int
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this ResponsePingPong.


        :param code: The code of this ResponsePingPong.  # noqa: E501
        :type: int
        """
    ...
    @property
    def status(self):
        """Gets the status of this ResponsePingPong.  # noqa: E501


        :return: The status of this ResponsePingPong.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ResponsePingPong.


        :param status: The status of this ResponsePingPong.  # noqa: E501
        :type: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this ResponsePingPong.  # noqa: E501


        :return: The message of this ResponsePingPong.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this ResponsePingPong.


        :param message: The message of this ResponsePingPong.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponsePingPong, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponsePingPong):
            return False
